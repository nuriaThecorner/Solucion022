...
namespace Principal.Controllers
{
    public class EmpleadoController : Controller
    {
        ...
        public ActionResult EmployeesOrders (int? id)
        {
            ...
            IList<Empleado> employees = db.Empleado.Include(x => x.Pedido).ToList();


            Empleado employee = employees.Where(x => x.EmployeeID == id).FirstOrDefault();
